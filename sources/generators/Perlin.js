//!requires:Generator
//!provides:Generator.Perlin
//
//!requires:JS.Class

Generator.Perlin = new JS.Class('Generator.Perlin', {
	...
	initialize: function (table) {
		this._table = table || this.klass.makeTable( 255 );
	...
	_smooth : function ( point, dimension ) {
		...
		return this.klass.cosineInterpolate( a, b, fractional );
	},
