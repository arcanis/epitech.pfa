//!requires:Helper
//!provides:Helper.generateBlockGeometries
// 
//!uses:Helper.getFacesIdentifier

Helper.generateBlockGeometries = (function ( ) {
	...
	return function ( materialsArray ) {
		...
		forEachFaceCombination(function ( faces ) {
			var identifier = Helper.getFacesIdentifier( faces );
			...
			for ( var t = 0, l = materialsList.length; t < l; ++ t ) {
				...
				identifier = Helper.getFacesIdentifier( faces );
